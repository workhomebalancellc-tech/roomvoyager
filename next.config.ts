        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' *.expediagroup.com *.travelpayouts.com tpwdgt.com *.tpwdgt.com tpo.gg *.tpo.gg kiwi.com *.kiwi.com api.kiwi.com autocomplete.kiwi.com services.kiwi.com *.rapidapi.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://www.googleapis.com https://firebaseinstallations.googleapis.com https://*.firebaseio.com wss://*.firebaseio.com cruisedirect.com *.cruisedirect.com https://api.airtable.com",
              "img-src 'self' data: blob: *.expediagroup.com *.travelpayouts.com tpwdgt.com *.tpwdgt.com *.kiwi.com *.googleusercontent.com images.unsplash.com lh3.googleusercontent.com *.lduhtrp.net *.jdoqocy.com *.cruisedirect.com *.cloudfront.net *.awltovhc.com logo.clearbit.com",
