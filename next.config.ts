        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' *.expediagroup.com *.travelpayouts.com tpwdgt.com *.tpwdgt.com tpo.gg *.tpo.gg *.kiwi.com *.rapidapi.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://www.googleapis.com https://firebaseinstallations.googleapis.com https://*.firebaseio.com wss://*.firebaseio.com cruisedirect.com *.cruisedirect.com https://api.airtable.com",
