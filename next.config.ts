        ...
        headers: [
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: *.expediagroup.com *.travelpayouts.com *.googleusercontent.com images.unsplash.com lh3.googleusercontent.com *.lduhtrp.net *.jdoqocy.com *.cruisedirect.com *.cloudfront.net *.awltovhc.com logo.clearbit.com",
