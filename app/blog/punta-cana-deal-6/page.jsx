      ...
      <div style={{ minHeight: "100vh", background: "#F8FAFF", fontFamily: "system-ui, -apple-system, sans-serif" }}>
        ...
        <div style={{ position: "relative", height: "340px", overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 24px", textAlign: "center" }}>
            ...
            <h1 style={{ color: "#fff", fontSize: "clamp(22px, 4vw, 42px)", fontWeight: "800", margin: "0 0 10px", lineHeight: 1.15, textShadow: "0 2px 14px rgba(0,0,0,0.4)" }}>
              Four Points Sheraton vs. The Westin Puntacana.
            </h1>
        ...
        <div style={{ maxWidth: "780px", margin: "0 auto", padding: "52px 24px 80px" }}>
          ...
          <p style={{ fontSize: "17px", lineHeight: 1.8, color: "#374151", marginBottom: "20px" }}>
            Marriott's brand portfolio gives travelers a powerful tool: the ability to earn the same Bonvoy points at properties ranging from budget-friendly Four Points to full-service Westin resorts. In Punta Cana, both brands have strong representations — and this week's deal puts them head to head for Feb 7–14. Same loyalty currency. Very different hotel experiences.
          </p>
          <p style={{ fontSize: "17px", lineHeight: 1.8, color: "#374151", marginBottom: "48px" }}>
            Four Points by Sheraton Puntacana comes in at $137 a night — a 9.0-rated resort with a full pool, spa, and Bonvoy loyalty integration in Punta Cana Village near the international airport. The Westin Puntacana Resort lands at $286 a night — a 9.0-rated full-service resort with the Westin's signature wellness positioning, superior amenities, and a setting that delivers the premium Caribbean experience the brand is known for. Same guest rating, $149 more per night. The question is what that $149 buys.
          </p>

          <p style={{ fontSize: "15px", lineHeight: 1.6, color: NAVY, fontWeight: "700", fontStyle: "italic", textAlign: "center", margin: "0 0 48px", borderLeft: `3px solid ${ORANGE}`, paddingLeft: "16px" }}>
            Bonvoy points either way. Four Points value at $137 or Westin resort experience at $286. Same 9.0 rating. Different worlds.
          </p>
          ...
          <div style={{ marginBottom: "56px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px", flexWrap: "wrap" }}>
              <h2 style={{ fontSize: "26px", fontWeight: "800", color: "#111827", margin: 0 }}>
                Four Points by Sheraton Puntacana — Marriott Resort Quality at the Entry Level
              </h2>
            ...
            <p style={{ fontSize: "16px", lineHeight: 1.8, color: "#374151", marginBottom: "16px" }}>
              The Four Points by Sheraton Puntacana delivers exactly what the brand promises: a reliable, well-run Marriott-family resort that earns Bonvoy points on every stay without requiring a flagship price tag. Located in Punta Cana Village adjacent to the international airport, it offers a full pool, spa, on-site dining, and the service consistency that has made Four Points one of Marriott's most trusted mid-range brands globally. The 9.0 guest rating from over 1,000 reviews confirms it consistently delivers.
            </p>
            <p style={{ fontSize: "16px", lineHeight: 1.8, color: "#374151", marginBottom: "16px" }}>
              At $137 a night for February 7–14, Four Points is the smart Bonvoy play for travelers who want Marriott quality in Punta Cana without the Westin premium. The savings versus the Westin — $149 per night, over $1,000 for the full week — can fund a Saona Island day trip, a catamaran excursion, and some of the best seafood restaurants in the Bávaro area. Points on every night accelerate toward future Bonvoy rewards.
            </p>
            ...
            <a
              href="https://expedia.com/affiliates/workhomebalance_llc/pca6_1"
              target="_blank"
          ...
          <div style={{ marginBottom: "56px" }}>
            ...
            <p style={{ fontSize: "16px", lineHeight: 1.8, color: "#374151", marginBottom: "16px" }}>
              At $286 a night — the same 9.0 guest rating as the Four Points but at double the price — the Westin justifies its premium through a meaningfully elevated resort experience: better amenities, more sophisticated design, a stronger wellness program, and the overall feel of a property that targets travelers for whom the hotel experience itself is part of the vacation. Bonvoy points accrue at the premium rate. For the right traveler, this is the definitive Punta Cana Marriott experience.
            </p>
            <p style={{ fontSize: "15px", lineHeight: 1.7, color: "#6B7280", marginBottom: "24px", fontStyle: "italic" }}>
            ...
            <a
              href="https://expedia.com/affiliates/workhomebalance_llc/pca6_2"
              target="_blank"
              rel="noopener noreferrer"
              style={{ display: "inline-block", background: ORANGE, color: "#fff", padding: "14px 28px", borderRadius: "12px", fontSize: "15px", fontWeight: "800", textDecoration: "none", boxShadow: "0 4px 14px rgba(255,102,0,0.35)" }}
            >
          ...
          <div style={{ background: "#EBF3FF", borderRadius: "20px", padding: "36px 32px", marginBottom: "48px" }}>
            ...
            <p style={{ fontSize: "16px", lineHeight: 1.8, color: "#374151", marginBottom: "12px" }}>
              Choose <strong>Four Points by Sheraton Puntacana</strong> if you want Marriott Bonvoy quality in Punta Cana at the best value — 9.0 rating, pool and spa, $137 a night.
            </p>
            ...
            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
              <a href="https://expedia.com/affiliates/workhomebalance_llc/pca6_1" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", background: ORANGE, color: "#fff", padding: "13px 24px", borderRadius: "12px", fontSize: "14px", fontWeight: "800", textDecoration: "none" }}>
                Four Points Sheraton →
              </a>
              <a href="https://expedia.com/affiliates/workhomebalance_llc/pca6_2" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", background: NAVY, color: "#fff", padding: "13px 24px", borderRadius: "12px", fontSize: "14px", fontWeight: "800", textDecoration: "none" }}>
