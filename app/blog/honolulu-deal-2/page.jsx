    ...
    <>
      <div style={{ minHeight: "100vh", background: "#F8FAFF", fontFamily: "system-ui, -apple-system, sans-serif" }}>
        ...
        <div style={{ position: "relative", height: "340px", overflow: "hidden" }}>
          <img src="/Deals/53/honolulu_destination.jpg" alt="Honolulu Waikiki" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center 40%" }} />
        ...
        <div style={{ maxWidth: "780px", margin: "0 auto", padding: "52px 24px 80px" }}>
          ...
          <div style={{ marginBottom: "56px" }}>
            <img src="/Deals/53/kuhiobanyan1.jpg" alt="Kuhio Banyan Club Honolulu" style={{ width: "100%", height: "260px", objectFit: "cover", borderRadius: "16px", marginBottom: "28px" }} />
          ...
          <div style={{ marginBottom: "56px" }}>
            <img src="/Deals/53/pagodahotel1.jpg" alt="Pagoda Hotel Honolulu" style={{ width: "100%", height: "260px", objectFit: "cover", borderRadius: "16px", marginBottom: "28px" }} />
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px", flexWrap: "wrap" }}>
