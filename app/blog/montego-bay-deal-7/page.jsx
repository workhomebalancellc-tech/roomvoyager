    ...
    <>
      <div style={{ minHeight: "100vh", background: "#F8FAFF", fontFamily: "system-ui, -apple-system, sans-serif" }}>
        ...
        <div style={{ position: "relative", height: "340px", overflow: "hidden" }}>
          <img src="/Deals/64/montegobay_destination.jpg" alt="Jamaica resort coastline" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center 50%" }} />
        ...
        <div style={{ maxWidth: "780px", margin: "0 auto", padding: "52px 24px 80px" }}>
          ...
          <div style={{ marginBottom: "56px" }}>
            <img src="/Deals/65/hotel39jamacia1.jpg" alt="Hotel 39 Jamaica Montego Bay" style={{ width: "100%", height: "260px", objectFit: "cover", borderRadius: "16px", marginBottom: "28px" }} />
          ...
          <div style={{ marginBottom: "56px" }}>
            <img src="/Deals/65/roundhillhotel1.jpg" alt="Round Hill Hotel and Villas Jamaica" style={{ width: "100%", height: "260px", objectFit: "cover", borderRadius: "16px", marginBottom: "28px" }} />
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px", flexWrap: "wrap" }}>
