    ...
    <>
      <div style={{ minHeight: "100vh", background: "#F8FAFF", fontFamily: "system-ui, -apple-system, sans-serif" }}>
        ...
        <div style={{ position: "relative", height: "340px", overflow: "hidden" }}>
          <img
            src="/Deals/46/cancun_destination.jpg"
        ...
        <div style={{ maxWidth: "780px", margin: "0 auto", padding: "52px 24px 80px" }}>
          ...
          <p style={{ fontSize: "17px", lineHeight: 1.8, color: "#374151", marginBottom: "20px" }}>
            A November getaway to Cancún — checking in November 12th, out on the 14th — is exactly the kind of mid-month escape that resets everything. The summer crowds are behind you, the Hotel Zone is running at a pace that actually lets you breathe, and the weather is as good as it gets. Two nights, some sun, and an all-inclusive that handles everything else.
          </p>
          ...
          <div style={{ marginBottom: "56px" }}>
            <img
              src="/Deals/46/parkroyalbeachcancun1.jpg"
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px", flexWrap: "wrap" }}>
              ...
              <span style={{ background: "#EFF6FF", color: "#1D4ED8", fontSize: "13px", fontWeight: "800", padding: "4px 12px", borderRadius: "20px", whiteSpace: "nowrap" }}>$276 / night all-inclusive</span>
            </div>
            ...
            <p style={{ fontSize: "16px", lineHeight: 1.8, color: "#374151", marginBottom: "16px" }}>
              At $276 a night all-inclusive, this is where the value math gets interesting. You're covered for the stay — food, drinks, beach chairs, pools — and you still have money left over for a day trip to Tulum, a sunset boat tour, or a splurge dinner off-property if the mood strikes. It's all-inclusive as a foundation, not a cage.
            </p>
          ...
          <div style={{ marginBottom: "56px" }}>
            <img
              src="/Deals/46/moonpalacecancun1.jpg"
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px", flexWrap: "wrap" }}>
              ...
              <span style={{ background: "#DCFCE7", color: "#166534", fontSize: "13px", fontWeight: "800", padding: "4px 12px", borderRadius: "20px", whiteSpace: "nowrap" }}>$493 / night all-inclusive</span>
            </div>
            <p style={{ fontSize: "16px", lineHeight: 1.8, color: "#374151", marginBottom: "16px" }}>
            ...
            <p style={{ fontSize: "16px", lineHeight: 1.8, color: "#374151", marginBottom: "16px" }}>
              For a family getaway, the scale starts making real sense. Everyone in the family can do their own thing — and still end up at the same dinner table at the end of the day. Teens have the waterpark and the arcade. Younger kids have the club and the pools. Adults have the spa and the beach. The all-inclusive covers all of it. At $493 a night, you're paying for a full-service vacation that runs itself.
            </p>
            <p style={{ fontSize: "15px", lineHeight: 1.7, color: "#6B7280", marginBottom: "24px", fontStyle: "italic" }}>
          ...
          <div style={{ textAlign: "center", padding: "12px 0" }}>
            <p style={{ fontSize: "18px", fontWeight: "800", color: "#111827", margin: "0 0 8px" }}>
              Cancún in November. One of those trips that pays for itself. 🌊
            </p>
