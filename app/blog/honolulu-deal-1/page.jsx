      ...
      <div style={{ minHeight: "100vh", background: "#F8FAFF", fontFamily: "system-ui, -apple-system, sans-serif" }}>
        ...
        <div style={{ maxWidth: "780px", margin: "0 auto", padding: "52px 24px 80px" }}>
          ...
          <div style={{ marginBottom: "56px" }}>
            <img src="https://images.unsplash.com/photo-1455587734955-081b22074882?w=900&h=500&fit=crop&auto=format" alt="Bposhtels Waikiki Retreat" style={{ width: "100%", height: "260px", objectFit: "cover", borderRadius: "16px", marginBottom: "28px" }} />
