...
export default function PromoBanner() {
  ...
  const [bannerText, setBannerText] = useState("🎉 Deals of the Week — Earn 2× points on hotels & cruises!");
  ...
  useEffect(() => {
    fetch("/api/admin/settings")
      ...
      .then(d => {
        ...
        if (d.promoBannerText?.trim()) setBannerText(d.promoBannerText.trim());
        setShow(true);
      })
      .catch(() => {});
  }, []);
